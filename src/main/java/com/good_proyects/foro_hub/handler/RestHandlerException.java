package com.proyects.foro_hub.handler;
import java.net.URI;
...
public class RestHandlerException {
    ...
    ProblemDetail handlerValidationError(MethodArgumentNotValidException ex){
        ...
        problemDetail.setType(URI.create("https://Projects.com/error/Argument_not_valid"));
    ...
    ProblemDetail handlerResourceNotFoundException(ResourceNotFoundException ex){
        ...
        problemDetail.setType(URI.create("https://Projects.com/error/not_found"));
        return problemDetail;
    }
    ...
    ProblemDetail handlerBadRequestException(BadRequestExcepton ex){
        ...
        problemDetail.setType(URI.create("https://Projects.com/error/bad_request"));
        return problemDetail;
    }
}
